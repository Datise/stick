...
boolean onPatterns = false;
uint32_t CYCLE_TIME = 8; // Time, in seconds, between auto-cycle images
...
//#define BTN_BRIGHT_UP    2
//#define BTN_BRIGHT_DOWN  0xFF20DF
//#define BTN_RESTART      0xFFF00F
//#define BTN_BATTERY      0xFF609F
//#define BTN_FASTER       0xFF708F
//#define BTN_SLOWER       0xFF30CF
//#define BTN_OFF          0xFFE01F
//#define BTN_IMAGE_PREV   0xFF10EF
//#define BTN_IMAGE_NEXT   0xFF50AF
//#define BTN_PATTERN_PREV 0xFF08F7
//#define BTN_PATTERN_NEXT 0xFF48B7
//#define BTN_AUTOPLAY     0XFFD02F
//#define BTN_IMAGES       0xFFB04F
//#define BTN_PATTERNS     0XFF8877

/* Keychain */
//#define BTN_BRIGHT_UP      0x820
//#define BTN_BRIGHT_UP_2    0x20
//
//#define BTN_BRIGHT_DOWN    0x821
//#define BTN_BRIGHT_DOWN_2  0x21
//
//#define BTN_RESTART      0xFFF00F
//#define BTN_BATTERY      0xFF609F
//#define BTN_FASTER       0xFF708F
...
//#define BTN_OFF          0xFFE01F
//
//#define BTN_IMAGE_PREV   0x811
//#define BTN_IMAGE_PREV_2   0x811
//
//#define BTN_IMAGE_NEXT   0x810
//#define BTN_IMAGE_NEXT_2 0x10
//
//#define BTN_PATTERN_PREV 0xFF08F7
//#define BTN_PATTERN_NEXT 0xFF48B7
//#define BTN_AUTOPLAY     0XFFD02F
//#define BTN_IMAGES       0xFFB04F
//#define BTN_PATTERNS     0X80B
...
#define BTN_FASTER       0xFF708F
#define BTN_SLOWER       0xFF30CF
#define BTN_OFF          0xFF02FD
#define BTN_IMAGE_PREV   0xFF08F7
#define BTN_IMAGE_NEXT   0xFF28D7
#define BTN_PATTERN_PREV 0xFF8877
#define BTN_PATTERN_NEXT 0xFFA857
#define BTN_AUTOPLAY     0XFF827D
#define BTN_IMAGES       0xFF30CF
#define BTN_PATTERNS     0XFFB04F
...
uint8_t  imageNumber   = 0,  // Current image being displayed
         patternNumber = 0,  // Current pattern being displayed
...
void loop() { 
  ...
  if (!onPatterns) {
    ...
    switch(patternNumber) {
      ...
      case 1:
        ...
        break;
      case 2:
        colorWipe(strip.Color(random(255),random(255),random(255)), 0);
        break;
    }
  }
  ...
  if (results.value == BTN_PATTERNS) {
    onPatterns = true;
    Serial.println("Switching to patterns");
  } else if (results.value == BTN_IMAGES) {
    onPatterns = false;
    Serial.println("Switching to images");
  }
